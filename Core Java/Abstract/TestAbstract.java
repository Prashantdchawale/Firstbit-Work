...
class TestEmpSal {
    public static void main(String[] args) {
    	...
    	Emp e1;  // reference of abstract class

        e1 = new Hr(104, "Dhoni", 40000, 4000);
        e1.display();
        System.out.println();

        e1 = new Salesmanger(105, "Rahul", 50000, 5000, 50);
        e1.display();
        System.out.println();

        e1 = new Admin(106, "Virat", 60000, 6000);
        e1.display();
        System.out.println();

        e1 = new AsalesManger("North Zone", 107,"Rohit", 70000, 7000, 45);
        e1.display();
    }
}
