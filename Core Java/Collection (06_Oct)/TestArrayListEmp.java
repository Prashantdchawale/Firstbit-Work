...
class TestArrayListEmp
{
	public static void main(String[] args) {
		...
		//System.out.println(a1);          //it will print all objects in single line
		//System.out.println(a1.get(4)); //java.lang.IndexOutOfBoundsException	
        }
}